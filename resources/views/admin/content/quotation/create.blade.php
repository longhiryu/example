                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3 float-right w-75">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="tax">Tax (default 10%):</label>
                                </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="input-group mb-3 col-md-9 pr-1">
                                    <input id="addProduct" value="" type="text" class="form-control">
                                </div>
                                <div class="col-md-3 pl-1">
                                    <button type="button" class="clear-list btn btn-danger btn-sm mt-1 float-right">Clear list</button>
                                    <button type="button" class="update-list btn btn-info btn-sm mt-1 mr-1 float-right">Update list</button>
                                </div>
                            </div>
